...
in
  runTests {
    ...
    testFunctionArgsMakeOverridable = {
      expr = functionArgs (makeOverridable ({
        a,
        b,
        c ? null,
      }: {}));
    ...
    */
    ...
    in {
      expr = {
        ...
        testDuplicatePruningBehaviour = attrsToList (builtins.listToAttrs [
          {
            name = "a";
            value = 2;
          }
    ...
    testToExtension = {
      expr = [
        ...
        (fix (extends (toExtension (final: prev: {
            a = 1;
            b = prev.a;
            c = final.a + 1;
          })) (final: {
