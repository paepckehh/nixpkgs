    ...
    self: super:
      {
        ...
        mbox =
          appendPatch ./patches/mbox-time-1.10.patch
          (overrideCabal {
              editedCabalFile = null;
              revision = null;
            }
        ...
        sexpr =
          appendPatch ./patches/sexpr-0.2.1.patch
          (overrideCabal (drv: {
              isExecutable = false;
        ...
        pandoc = assert super.pandoc.version == "3.1.11.1";
        ...
        gi-gtk-declarative = overrideCabal (drv:
